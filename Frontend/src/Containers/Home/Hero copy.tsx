...
const Hero: React.FC<HeroSliderProps> = ({ heroInView }) => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4 hero-content w-full">
        <motion.h1
        ...
        >
          ...
          From intimate gatherings to grand festivities, we bring your dreams to
