      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-end mb-6">
          ...
          >
            ...
            {isShuffled ? "Shuffled!" : "Shuffle Themes"}
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              {/* Image Container - UPDATED for full width display */}
              <div className="relative w-full overflow-hidden bg-black">
                ...
                <img
                  ...
                  className={`w-full ${
                    !loadedImages[item.image] ? "hidden" : "block"
        ...
        {/* Alternative Layout with Masonry-like effect for mixed aspect ratios */}
        {false && ( // Set to true if you want to try masonry layout
          <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6">
            {filteredItems.map((item, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1 }}
                transition={{ delay: index * 0.05 }}
                className="mb-6 break-inside-avoid group relative bg-gradient-to-br from-zinc-900/50 to-black/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all duration-500 shadow-xl"
              >
                {/* Category Badge */}
                <div className="absolute top-3 left-3 z-10">
                  <span className="px-3 py-1 bg-black/80 backdrop-blur-sm text-xs text-yellow-500 font-semibold rounded-full border border-yellow-500/30">
