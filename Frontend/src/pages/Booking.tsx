...
const Booking = () => {
  ...
  // Update form data when selectedService or selectedPackage changes
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            Ready to create an unforgettable celebration? Fill out the form
            below and let's start planning your perfect event together.
          </motion.p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Please select a date between today and{" "}
